    ...
    trip = {
      {
        ...
        spawn_clone   = true,                        -- spawn clone?         true or false
        ...
        play_song     = 'files/gone.mp3',       -- play song during?    false or string (if using fivem-getwave, must be getwave file string (e.g: 'files/altar.mp3'), if not, must be youtube video ID)
