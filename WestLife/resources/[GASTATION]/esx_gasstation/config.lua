...
Config.webhook = "https://discord.com/api/webhooks/960482764375863306/aPo7vwd-fE2EaAsZV8LaichYhTCk0N0gCA8ibPPOCzFgWpKc73D9-YcoS1QNJaAec4md"						-- Webhook to send logs to discord
...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		['buy_price'] = 500000,									-- Price to buy this gas station
		['sell_price'] = 40000,								-- Price to sell this gas station
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['min_gas_price'] = 2,					-- Minimum price that the owner can apply
		['max_gas_price'] = 7,					-- Maximum price that the owner can apply
