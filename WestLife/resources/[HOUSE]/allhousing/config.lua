...
Config = {
  ...
  UseHelpText       = true,  -- if using HelpText (instead of 3DText).
  Use3DText         = false,   -- if using 3DText (instead of HelpText).
  ...
  RefundPercent    = 20,    -- percent of price to refund for furniture.
  ...
  LockpickFailChance        = 98,            -- % failure chance, if not using minigames for lockpicking.
  ...
  UsingProgressBars   = true,         -- if not using either lockpicking versions, and want to use progress bars while performing lockpick animation.
  ...
  CreationJobs = {   
      ...
      account = 'society_broker', -- society account name
