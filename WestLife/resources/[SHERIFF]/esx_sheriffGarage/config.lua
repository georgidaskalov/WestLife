...
Config.CarZones = {
	sheriffCarGarage = {
		Pos = {
			{x = -463.3749, y = 6009.9629, z = 31.8405},
		}
	}
}
...
Config.HeliZones = {
	sheriffHeliGarage = {
		Pos = {
			{x = -477.1871, y = 5989.7051, z = 37.3853},
		}
	}
}
...
-- sheriff Extra Menu Blip Settings:
...
Config.sheriffCarMarker = 36 												-- marker type
...
Config.sheriffHeliMarker = 34 												-- marker type
...
Config.sheriffBoatMarker = 35 												-- marker type
...
-- sheriff Extra Garage Marker Settings:
Config.sheriffExtraMarker = 27 												-- marker type
Config.sheriffExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.sheriffExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~sheriff Extra Menu~s~"		-- set your desired text here

-- sheriff Cars:
Config.sheriffVehicles = {
		{ model = 'bcso1', label = 'Ford'},
		{ model = 'bcso2', label = 'Dodge'},
		{ model = 'bcso3', label = 'Dodge2'},	
		{ model = 'bcso4', label = 'Chevy'},	
		--{ model = 'bcso5', label = 'Chevy2'},	
		--{ model = 'bcso6', label = 'Dodge3'},					
}

-- sheriff Helicopters:
Config.sheriffHelicopters = {
	{ model = 'sheriffmav', label = 'Шерифски Хеликоптер', modLivery = 0, price = 0 }
}

-- sheriff Boats:
Config.sheriffBoats = {
	--{ model = 'predator', label = 'sheriff Predator', livery = 0, price = 0 }
}
...
Config.TitlesheriffGarage = "Гараж"
Config.TitlesheriffExtra = "Допълнително"
Config.TitlesheriffLivery = "Livery"
...
Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~sheriff Boat Garage~s~!"
