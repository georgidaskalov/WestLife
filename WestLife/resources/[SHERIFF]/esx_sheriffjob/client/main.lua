...
function OpenPoliceActionsMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
        ...
        elements = {
            ...
            --{label = '<span style="color:#0B80F4;"> Шерифски радар<span style="color:cyan;">', value = 'radar'},
            { label = '<span style="color:#0B80F4;"> Меню затвор<span style="color:cyan;">', value = 'jail' }
        } }, function(data, menu)
...
function POLICE_radar()
    if isRadarPlaced then
        ...
        if maxSpeed ~= nil then
            -- maxSpeed = nil only if the player hasn't entered a valid number
    ...
    while true do
        ...
        if isRadarPlaced then
            ...
            if HasObjectBeenBroken(Radar) then
                -- check is the radar is still there
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), RadarPos.x, RadarPos.y, RadarPos.z, true) > 100 then
                -- if the player is too far from his radar
