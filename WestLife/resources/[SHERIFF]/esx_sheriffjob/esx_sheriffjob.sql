...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('sheriff',0,'recruit','Новак',20,'{}','{}'),
	('sheriff',1,'officer','Градски Патрул',40,'{}','{}'),
	('sheriff',2,'sergeant','Магистрален Патрул',60,'{}','{}'),
	('sheriff',4,'lieutenant','Заместник Шеф',85,'{}','{}'),
	('sheriff',5,'boss','Шеф',100,'{}','{}')
;
