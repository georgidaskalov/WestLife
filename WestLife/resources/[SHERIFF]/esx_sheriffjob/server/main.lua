...
RegisterServerEvent('esx_sheriffjob:confiscatePlayerItem') --return to serverevent if broken
AddEventHandler('esx_sheriffjob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	local _source = source
	local sourceXPlayer = ESX.GetPlayerFromId(_source)
	local targetXPlayer = ESX.GetPlayerFromId(target)

	if sourceXPlayer.job.name ~= 'police' and sourceXPlayer.job.name ~= 'sheriff' then
