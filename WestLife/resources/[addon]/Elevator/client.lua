...
elevators = {
    [1] = { -- 398 F.I.B.
        -- Floor 1
        {345.76, -582.48, 28.79, "Рецепция / Гараж"},  
        -- Floor 2
        {327.13, -603.84, 43.28, "Главен етаж"}, 
        -- Floor 3
        {338.57, -583.93, 74.16, "Таван"}  
    },
    [2] = { -- 1002 Army Base
	...
	[5] = { -- 398 F.I.B.
        -- Floor 1
        {-1370.42, -503.53, 33.15, "Излез"},   --60, 42, 74, 128.2369
        -- Floor 2
        {-1392.73, -480.73, 72.04, "Главен етаж"} 
    },
}
