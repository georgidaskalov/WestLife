...
if Config.EnableHUD then
	...
	--			DrawAdvancedText(0.200 - x, 0.935 - y, 0.14, 0.0050, 0.57, fuel ,255, 255, 255, 255, 6, 1)


			--		DrawAdvancedText(0.283 - x, 0.97 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 250, 6, 1)
		DrawAdvancedText(0.271 - x, 0.930 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 210, 6, 1)
-- DISABLE THESE TO HIDE THE SPEEDOMETER START OF THE CODE
		--DrawAdvancedText(0.271 - x, 0.987 - y, 0.005, 0.0028, 0.6, mph, 255, 255, 255, 210, 6, 1)
		DrawAdvancedText(0.272 - x, 0.967 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 210, 6, 1)

		DrawAdvancedText(0.292 - x, 0.9750 - y, 0.005, 0.0028, 0.4, "км/ч", 255, 255, 255, 150, 6, 1)
-- DISABLE THESE TO HIDE THE SPEEDOMETER END OF THE CODE
		DrawAdvancedText(0.290 - x, 0.940 - y, 0.005, 0.0028, 0.4, "% гориво", 235, 235, 235, 150, 6, 1)
--		DrawAdvancedText(0.299 - x, 0.975 - y, 0.005, 0.0028, 0.5, "% гориво", 235, 235, 235, 250, 6, 1)
...
--		DrawAdvancedText(0.283 - x, 0.97 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 250, 6, 1)
		DrawAdvancedText(0.120 - x, 0.987 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 210, 6, 1)
-- DISABLE THESE TO HIDE THE SPEEDOMETER START OF THE CODE
		DrawAdvancedText(0.171 - x, 0.987 - y, 0.005, 0.0028, 0.6, mph, 255, 255, 255, 210, 6, 1)
		DrawAdvancedText(0.223 - x, 0.987 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 210, 6, 1)

		DrawAdvancedText(0.192 - x, 0.9950 - y, 0.005, 0.0028, 0.4, "mp/h                 km/h                  ", 255, 255, 255, 150, 6, 1)
-- DISABLE THESE TO HIDE THE SPEEDOMETER END OF THE CODE
		DrawAdvancedText(0.137 - x, 0.9950 - y, 0.005, 0.0028, 0.4, "% fuel", 235, 235, 235, 150, 6, 1)
--		DrawAdvancedText(0.299 - x, 0.975 - y, 0.005, 0.0028, 0.5, "% гориво", 235, 235, 235, 250, 6, 1)
	end
end
