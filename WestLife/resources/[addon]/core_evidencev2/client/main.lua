        ...
        while true do
            ...
            if job == Config.JobRequired and grade >= Config.JobGradeRequired then
                ...
                if veh ~= 0 then
                    ...
                    if gloves < 20 and   gloves ~= 22 and gloves ~= 56 and gloves ~= 57 and gloves ~= 58 and gloves ~= 59 and gloves ~= 60 and gloves ~= 61 and gloves ~= 62  and gloves ~= 65 and gloves ~= 66 and gloves ~= 122 and gloves ~= 129 and gloves ~= 136 then
                        last = 0
                    else
                        last = lastped
                    end
