...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'Избрано') {
            $(document).find(".addjob").text('Избери');
            $(this).text('Избрано');
