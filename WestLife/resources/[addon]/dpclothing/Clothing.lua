...
local Drawables = {
	["Top"] = {
		Drawable = 11,
		Table = {
			Standalone= true, Male= 178, Female=168,
			Extra = { 
				{Drawable = 8, Id = 14, Tex = 0, Name = "Extra Undershirt"},
				 {Drawable = 3, Id = 15, Tex = 0, Name = "Extra Gloves"},
				 {Drawable = 0, Id = 0, Tex = 0, Name = "Extra Decals"},
			  }
		},
	...
	["Bag"] = {
		Drawable = 5,
		Table = Variations.Bag,
		Remember = true,
		Emote = {Dict = "clothingtie", Anim = "try_tie_negative_a", Move = 51, Dur = 1300}
	},
	["Mask"] = {
		Drawable = 1,
		Table = {Standalone = true, Male = 0, Female = 0 },
...
local Extras = {
	["Shirt"] = {
		Drawable = 11,
		Table = {
			Standalone = true, Male = 178, Female = 127,
			Extra = { 
	...
	["Pants"] = {
		Drawable = 4,
		Table = {Standalone = true, Male = 52, Female = 51},
...
local Props = {
	...
	["Bracelet"] = {
		Drawable = 4,
		Table = {Standalone = true, Male = 61, Female = 16},
		Emote = {Dict = "re@construction", Anim = "out_of_breath", Move = 51, Dur = 1300}
		},
	}
