...
Config.display = {
    ...
    {offset = -0.1, text = "~b~Собственик: ~r~{owner_rp_name} ~b~Цена: ~g~${price} ~s~(~r~{taxrate}% tax~s~)", scale = 1},
    {offset = -0.21, text = "~b~Печалба: ~g~${earnings}/hr", scale = 1}
}
...
Config.sell_percentage = 0.0 -- % from original price the player gets after selling business (1 = 100%, 0.5 = 50%)