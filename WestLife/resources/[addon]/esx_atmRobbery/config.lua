...
Config.PoliceBlipTime = 70				-- miliseconds that blip is active on map (this value is multiplied with 4 in the script)
...
Config.DispatchMessage = "^3 10-90 ^0 обир на банкомат на улица ^5%s^0"

-- Reward Settings:
Config.EnableDirtyCash = true			-- Set between true(receive dirty cash) or false(receive normal cash)		
Config.MinReward = 6000					-- Set minimum payout
Config.MaxReward = 8000 				-- Set maximum payout

-- Other Settings:
Config.RobCooldown = 40 					-- (minutes)
...
Config.ATMs = {
  ...
  --{x=-386.733, y=6045.953, z=31.501}, --paleto
  --{x=-283.15, y=6225.92, z=31.49}, --paleto
  ...
  --{x=1702.842, y=4933.593, z=42.051}, --sandy
  --{x=1967.333, y=3744.293, z=32.272}, --sandy
