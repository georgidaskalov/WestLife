...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			--TriggerServerEvent("pyrp_discord:sendToWebhook", "takefromplayer", "Put Into Player", '**Name:** '..GetPlayerName(PlayerId()) ..'\n**Target:** '..targetPlayerName..'\n**Item Type:** '..data.item.type..'\n**Item Name:** '..data.item.name..'\n**Count:** '..count..'')
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			--TriggerServerEvent("pyrp_discord:sendToWebhook", "takefromplayer", "Take From Player", '**Name:** '..GetPlayerName(PlayerId()) ..'\n**Target:** '..targetPlayerName..'\n**Item Type:** '..data.item.type..'\n**Item Name:** '..data.item.name..'\n**Count:** '..count..'')
        end
