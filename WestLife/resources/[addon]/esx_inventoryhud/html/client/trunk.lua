...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			TriggerServerEvent("pyrp_discord:sendToWebhook", "trunk", "Deposit Trunk", '**Name:** '..GetPlayerName(PlayerId())..' \n**Plate:** '..trunkData.plate..' \n**Item Type:** '..data.item.type..'\n**Item Name:** '..data.item.name..'\n**Count:** '..count..'\n**Item Label:** '..data.item.label..'')
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			TriggerServerEvent("pyrp_discord:sendToWebhook", "trunk", "Withdraw Trunk", '**Name:** '..GetPlayerName(PlayerId())..' \n**Plate:** '..trunkData.plate..' \n**Item Type:** '..data.item.type..'\n**Item Name:** '..data.item.name..'\n**Count:** '..tonumber(data.number)..'\n**Item Label:** '..data.item.label..'')
        end
