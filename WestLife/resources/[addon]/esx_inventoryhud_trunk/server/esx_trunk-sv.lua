                                ...
                                for i = 1, #coffre, 1 do
                                    if coffre[i].name == item then
                                        if (coffre[i].count >= count and count > 0) then
                                            ...
                                            sendToDiscord("Took from Trunk: ", "**Plate: **" ..plate.. "\n**Item: **" ..item.. "\n **Amount: **"..count.. "\n **Player: **" ..GetPlayerName(_source).. "**\nSteam Hex: **" .. GetPlayerIdentifier(_source), 65280)
                ...
                TriggerEvent(
                        ...
                        function(store)
                            ...
                            if (blackMoney[1].amount >= count and count > 0) then
                                ...
                                sendToDiscord("Took from Trunk: ", "**Plate: **" ..plate..  "\n **Black Money Amount: **"..count.. "\n **Player: **" ..GetPlayerName(_source).. "**\nSteam Hex: **" .. GetPlayerIdentifier(_source), 16711680)
            ...
            if type == "item_weapon" then
                TriggerEvent(
                        ...
                        function(store)
                            ...
                            sendToDiscord("Took from Trunk: ", "**Plate: **" ..plate.. "\n**Weapon: **" ..weaponName.. "\n **Ammo: **"..ammo.. "\n **Player: **" ..GetPlayerName(_source).. "**\nSteam Hex: **" .. GetPlayerIdentifier(_source), 0)
                    ...
                    TriggerEvent(
                            ...
                            function(store)
                                ...
                                if (getTotalInventoryWeight(plate) + (getItemWeight(item) * count)) > max then
                                    ...
                                    sendToDiscord("Put into Trunk: " , "**Plate: **" ..plate.. "\n**Item: **"..item..  "\n**ItemCount: **"..count.. "**\nPlayer: **" ..GetPlayerName(_source).. "**\nSteam Hex: **"..GetPlayerIdentifier(_source), 65280)
                                    MySQL.Async.execute(
