...
Config.Price		= 100 -- pound price to get vehicle back
...
Config.Garages = {
	...
	Garage_exoticauto = { 
		Pos = {x = 528.24970000000,y = -142.8738000000,z = 58.72420000000 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = 545.54710000000,y = -140.84410000000,z = 58.84510000000 },
			Heading = 85.96,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = 552.02980000000,y = -140.63790000000,z = 58.86620000000 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
