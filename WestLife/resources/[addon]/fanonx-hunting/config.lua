...
Config.Blips = {
    {coords = vector3(968.9594, -2107.9263, 30.4752), name = "Продажба на дивеч", sprite = 442, colour = 27},
    --{coords = vector3(-1133.44, 4605.55, 144.96), name = "Лов", sprite = 161, colour = 27},
    --{coords = vector3(-1133.44, 4605.55, 144.96), name = "Зона за лов", sprite = 442, colour = 27}
}
...
-- [LANGUAGE]:
Config.Text = {
    ['before_harvest']   = 'Натисни [~g~E~w~] за да разфасоваш',
	['harvesting']       = 'Разфасоване на дивеч...',
    ['need_knife']       = 'Трябва ти нож за да разфасоваш',
    ['receved_leather']  = 'Ти взе кожа',
	['ruined_leather']   = 'Кожата за нищо не става',
	['receved_meat']     = 'Взе месо',
	['special_item']     = 'Получи специален предмет',
    ----
    ['campfire']         = 'Натисни [~g~E~w~] to cook, [~g~G~w~] to remove',
    ['cooking']          = 'Cooking meat',
    ['placing_campfire'] = 'Placing campfire...',
    ['cant_place_camp']  = "You can't place your campfire here",
    ----
    ['cant_place_bait']  = "Не можеш да поставиш стръв тук",
    ['placing_bait']     = 'Поставяш стръв...',
    ['between_bait']     = 'Трябва да изчакаш, преди да сложиш стръв',
	['no_effects_bait']  = 'Нямаше полза от стръвта',
    ----
    ['sell_items']       = 'Натисни [~g~E~w~] за продажба',
	['sold']             = 'Успешна сделка',
	----
	['no_material']      = "Нямаш достатъчно материал",
    ['you_didnt_kill_it'] = "Животното не е убито от теб"
}