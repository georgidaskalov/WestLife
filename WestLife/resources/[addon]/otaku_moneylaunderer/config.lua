...
Config.baseRate = 90 -- The minimum launder rate (50% means for every $2 dirty, you get $1 clean)
...
Config.versionCheck = false -- On script startup, should we check for updates?

Config.callPoliceChance = 3 -- The higher this number, the less likely a CAD is sent to the police
Config.policeCooldown = 10000 -- How often can the CAD trigger for police in ms (default 10000 - 10s)
