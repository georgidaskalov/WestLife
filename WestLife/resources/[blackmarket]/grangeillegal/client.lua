...
local Shop = {x = 1540.059, y = 3593.78, z = 38.766}
local NPC = {
    {seller = true, model = "ig_g",x = 1540.059, y = 3593.78, z = 38.766, h = 118.63},
    {seller = false, model = "s_m_m_doctor_01", x = -492.07,  y = -342.58,  z = 41.32, h = 346.0},
    {seller = false, model = "s_m_y_waretech_01", x = -1460.59,  y = -413.18,  z = 34.82, h = 163.48},
}
