...
AuthorizedItems = {
  ...
  keys_forgang  = "bruh (4369)",
  keys_formafia  = "bruh (4368)",
  keys_formechanic  = "bruh (4376)",
  keys_formedic = "bruh (4339)",
  keys_foropenint1  = "bruh (4301)",
  keys_foropenint2  = "bruh (4302)",
  keys_foropenint3  = "bruh (4303)",
  keys_foropenint4  = "bruh (4304)",
  keys_foropenint5  = "bruh (4305)",
  keys_forpolice  = "bruh (4383)",
  keys_forweapons  = "bruh (4300)",
  keys_zanelegalni1  = "keys (what)",
}
...
Labels = {
  ...
  do_unlock         = "[~r~E~s~] ",
  do_lock           = "[~g~E~s~] ",
  access_granted    = "~g~Достъпът е разрешен.~s~",
  access_denied     = "~r~Достъпът е отказан.~s~",
  ...
  police_warning    = "Някой се опитва да разбие врата на %s. \nPress ~INPUT_PICKUP~ to set GPS."
}
