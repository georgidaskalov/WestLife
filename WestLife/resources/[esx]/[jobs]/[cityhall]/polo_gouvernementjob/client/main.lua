...
function OpenGouvernementActionsMenuGarde()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvernement_actions', {
		...
		elements = {
			...
			{label = '<span style="color:#0BF4B8;"> 🙎 Взаимодействие с гражданин.<span style="color:blue;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:#F4C60B;"> 🚗 Взаимодействие с коли<span style="color:blue;"> >', value = 'vehicle_interaction'},
			...
			{label = '<span style="color:#0BF427;"> 📦 Обекти<span style="color:blue;"> >', value = 'object_spawner'}
	}}, function(data, menu)
										...
										if amount == nil then
											...
											local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
												if closestPlayer == -1 or closestDistance > 3.0 then
													...
													TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_gouvernement', _U('gouvernement'), amount)
												end
										end
								end,
							function(data, menu)
		...
		--	local elements = {
			--	{label = '<span style="color:gold;">--------- 👨‍✈️ Кмет 👩‍✈️ ---------<span style="color:red;">', value = 'text'},
			----	{label = '<span style="color:green;">💭 Жът <span style="color:red;">', value = 'chat1'},
     ...
     -- }
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'securitymenu', {
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				{label = '<span style="color:green;">На смяна<span style="color:white;"> on duty', value = 'prise'},
				{label = '<span style="color:red;">Извън смяна<span style="color:white;"> on duty', value = 'fin'},
				{label = '<span style="color:orange;">Почивка<span style="color:white;"> on duty', value = 'pause'}
			}
...
function OpenGouvernementActionsMenuPresident()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvernement_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:#0BF4B8;"> 🙎 Взаимодейстие с граждани<span style="color:blue;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:red;">💬 Чат президент<span style="color:blue;"> >', value = 'chatentreprise'},
			{label = '<span style="color:#0BF427;"> 📦 Обекти<span style="color:blue;"> >', value = 'object_spawner'}
	}}, function(data, menu)
		...
		elseif data.current.value == 'chatentreprise' then
			...
			local elements = {
				{label = '<span style="color:gold;">--------- 👨‍✈️ Кмет 👩‍✈️ ---------<span style="color:red;">', value = 'text'},
				{label = '<span style="color:green;">💭 В офиса след 10 мин<span style="color:red;">', value = 'chat1'},
				{label = '<span style="color:green;">💭 В офиса след 15 мин<span style="color:red;">', value = 'chat2'},
                {label = '<span style="color:red;">💭 Започва работа<span style="color:red;">', value = 'chat3'},
                {label = '<span style="color:red;">💭 Приключва работа<span style="color:red;">', value = 'chat4'},
                {label = '<span style="color:red;">💭 Свободен за въпроси по телефон<span style="color:red;">', value = 'chat5'},
...
function OpenGouvernementActionsMenuPremierMinistre()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvernement_actions', {
		...
		elements = {
			{label = '<span style="color:#0BF4B8;"> 🙎 Взаимодейстие с граждани<span style="color:blue;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:red;">💬 Чат Зам.Кмет<span style="color:blue;"> >', value = 'chatpremierministre'},
			{label = '<span style="color:#0BF427;"> 📦 Обекти<span style="color:blue;"> >', value = 'object_spawner'}
	}}, function(data, menu)
		...
		elseif data.current.value == 'chatpremierministre' then
			...
			local elements = {
				{label = '<span style="color:gold;">-------- 👨‍✈️ Зам.Кмет 👩‍✈️ --------<span style="color:red;">', value = 'text'},
				{label = '<span style="color:yellow;">💭 Жълта заплаха<span style="color:red;">', value = 'chat9'},
                {label = '<span style="color:red;">💭 Червена заплаха<span style="color:red;">', value = 'chat10'},
                {label = '<span style="color:black;">💭 Черна заплаха <span style="color:red;">', value = 'chat11'},
                {label = '<span style="color:green;">💭 Полиция събрание<span style="color:red;">', value = 'chat12'},
			}
...
function OpenGouvernementActionsMenuGouvernement()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvernement_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:#0BF4B8;"> 🙎 Взмодействие с граждани<span style="color:blue;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:#0BF427;"> 📦 Обекти<span style="color:blue;"> >', value = 'object_spawner'}
	}}, function(data, menu)
...
AddEventHandler('gouvernement:InfoServiceGarde', function(service, nom)
	if service == 'prise' then
		...
		ESX.ShowAdvancedNotification('Община', '~b~Община', '~y~Общинар: ~g~'..nom..'\n~y~Information: ~g~Service plug.', 'CHAR_MULTIPLAYER', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'fin' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('Информация Община', '~b~Излиза от смяна', '~y~Общинар: ~g~'..nom..'\n~y~Information: ~g~End of service.', 'CHAR_MULTIPLAYER', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'pause' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('Информация Община', '~b~В почивка', '~y~Общинар: ~g~'..nom..'\n~y~Information: ~g~Break in service.', 'CHAR_MULTIPLAYER', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	end
end)
...
AddEventHandler('gouvernement:InfoChatGouv', function(service, nom, streetName)
    ...
    streetName = GetStreetNameFromHashKey(streetName)
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~r~Специално Съобщение', '~y~Жълт код', '~y~Кмета е в движение.\n~v~Позиция: ~r~'..streetName..'', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
    ...
    streetName = GetStreetNameFromHashKey(streetName)
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~r~Специално Съобщение', '~r~Червен код', '~r~Кмета е под обстрел!\n~v~Позиция: ~r~'..streetName..'', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
    ...
    streetName = GetStreetNameFromHashKey(streetName)
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~r~Специално Съобщение', '~v~Черен код', '~r~Кмета е ликвидиран!\n~v~Позиция: ~r~'..streetName..'', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
...
AddEventHandler('gouvernement:InfoChatGouvernement', function(service, nom)
    ...
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Кмет', '~y~Кмета ще се намира в неговият офис след 10 мин.', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'chat2' then
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Кмет', '~y~Кмета ще се намира в неговият офис след 15 мин.', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'chat3' then
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Кмет', '~y~Кмета влиза на смяна.', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'chat4' then
	local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Кмет', '~y~Кмета излиза от смяна.', 'CHAR_MP_FM_CONTACT', 8)		
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'chat5' then
	local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Кмет', '~y~Кмета е свободен за вашите въпроси по телефон', 'CHAR_MP_FM_CONTACT', 8)	
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'chat6' then
	local pos = GetEntityCoords(PlayerPedId())
    ...
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Зам.Кмет', '~y~Малка Заплаха.', 'CHAR_MP_FM_CONTACT', 8)
		Wait(1000)
	elseif service == 'chat10' then
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Зам.Кмет', '~r~Средна Заплаха.', 'CHAR_MP_FM_CONTACT', 8)
		Wait(1000)
	elseif service == 'chat11' then
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Зам.Кмет', '~v~Голяма Заплаха.', 'CHAR_MP_FM_CONTACT', 8)
		Wait(1000)
	elseif service == 'chat12' then
    local pos = GetEntityCoords(PlayerPedId())
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('~b~Община', '~g~Зам.Кмет', '~g~Среща на полицията след 1 час в РПУ.', 'CHAR_MP_FM_CONTACT', 8)
		Wait(1000)
	end
end)
