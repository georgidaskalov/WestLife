...
Config.ambulanceCarMarker = 36 												-- marker type
...
Config.ambulanceHeliMarker = 34 												-- marker type
...
Config.ambulanceBoatMarker = 35 												-- marker type
...
Config.ambulanceVehicles = {	
		{ model = 'vtp1', label = 'Линейка'},
		{ model = 'vtp2', label = 'Джип'},
		{ model = 'dodgeEMS', label = 'Кола'},
		{ model = 'dodgesamu', label = 'Кола'}
						
}

-- ambulance Helicopters:
Config.ambulanceHelicopters = {
	{ model = 'ec135', label = 'Хеликоптер', livery = 0, price = 0 }
}
...
Config.TitleambulanceGarage = "Гараж"
Config.TitleambulanceExtra = "Допълнително"
