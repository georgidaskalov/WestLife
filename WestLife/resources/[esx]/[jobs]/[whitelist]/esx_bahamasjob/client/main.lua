    ...
    function(data, menu)
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
		      ...
		      {label = _U('sake'),     value = 'sake'}, --customs
                      {label = _U('castella'),         value = 'castella'},
                      {label = _U('dorayaki'),    value = 'dorayaki'},
                      {label = _U('gyozo'),   value = 'gyozo'},
                      {label = _U('katsudon'),    value = 'katsudon'},
                      {label = _U('shabu_shabu'),     value = 'shabu_shabu'},
                      {label = _U('miso_soup'),        value = 'miso_soup'},
                      {label = _U('sushi'),      value = 'sushi'},
                      {label = _U('tempura'),        value = 'tempura'},
                      {label = _U('teriyaki'),      value = 'teriyaki'},
                      {label = _U('yakitori'),  value = 'yakitori'},
                      {label = _U('ramen'),  value = 'ramen'},
			{label = _U('matcha_tea'),        value = 'matcha_tea'},
                      {label = _U('bubble_tea'),      value = 'bubble_tea'},
                      {label = _U('melon_soda'),        value = 'melon_soda'},
                      {label = _U('calpis'),      value = 'calpis'},
                      {label = _U('beerjap'),  value = 'beerjap'},
                  }
              },
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_bahamasjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_bahamasjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_bahamasjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bahamas_actions') then
