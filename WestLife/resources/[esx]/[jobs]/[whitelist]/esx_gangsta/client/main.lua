...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['F6']) and PlayerData.job.name == 'broker' and IsInputDisabled(0) and not IsDead then
            OpenMobileBrokerActionsMenu() -- rework
        end
    end
end)

function OpenMobileBrokerActionsMenu()
    ESX.UI.Menu.CloseAll()

    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_broker_actions',
            {
                title = 'Broker',
                align = 'bottom-right',
                elements = {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
                        ...
                        if amount == nil then
                            ...
                            if closestPlayer == -1 or closestDistance > 3.0 then
                                ...
                                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_broker', 'Broker', amount)
