...
Config.Zones = {
	...
	ls1 = {
     ...
     ls1 = {
		Pos   = { x = -207.36, y = -1323.94, z = 30.23},
		Size  = {x = 5.0, y = 5.0, z = 0.5},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls1 = {
		Pos   = { x = -207.36, y = -1323.94, z = 30.03},
		Size  = {x = 5.0, y = 5.0, z = 0.5},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
ls1 = {
		Pos   = { x = -207.36, y = -1323.94, z = 30.13},
		Size  = {x = 5.0, y = 5.0, z = 0.5},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {2.2, 2.4, 1.6, 1.7}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.2, 2.4, 3.4, 1.3}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {1.7, 1.4, 2.8, 2.7, 2.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {1.7, 2.2, 3.0, 3.0, 3.2, 1.5}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
