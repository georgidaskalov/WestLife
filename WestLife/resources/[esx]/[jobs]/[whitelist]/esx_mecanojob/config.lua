...
Config.Zones = {
  ...
  MecanoActions = {
		Pos   = { x = -223.8115, y = -1320.539, z = 30.890},  
	...
	Garage = {
		Pos   = { x = -241.4108, y = -1327.632, z = 30.902 },  
		Size  = { x = 1.0, y = 1.0, z = 1.0 }, 
		Color = { r = 0, g = 255, b = 0 },
		Type  = 21
	},
	...
	Craft = {
		Pos   = { x = -240.2596, y = -1313.893, z = 30.902 },   
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 0, g = 0, b = 255 },
		Type  = 21
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -182.5169, y = -1313.5417, z = 31.29, h = 94.87 }, 
	...
	VehicleDeleter = {
		Pos   = { x = -164.4032, y = -1307.393, z = 31.244 }, 
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 0, b = 0 },
		Type  = 39,
	},
