...
Config.Zones = {
	...
	mechanicActions = {
		Pos   = { x = 1160.4258, y = -782.3164, z = 57.6051},
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 35, g = 57, b = 202 },
		Type  = 31
	},

	Garage = {
		Pos   = { x = 1149.318, y = -794.753, z = 57.605 },
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 35, g = 202, b = 57 },
		Type  = 21
	},

	Craft = {
		Pos   = { x = 1146.412, y = -794.695, z = 57.605},
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 7, g = 71, b = 247 },
		Type  = 21
	},

	VehicleSpawnPoint = {
		Pos   = { x = 1133.933, y = -797.960, z = 57.582},
	...
	VehicleDeleter = {
		Pos   = { x = 1125.463, y = -798.702, z = 57.657},
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 204, g = 0, b = 0 },
		Type  = 39,
	},
	...
	VehicleDelivery = {
		Pos   = { x = 544.0372, y = -212.086, z = 53.181},
