...
function OpenCloakroomMenu()
	...
	--[[elseif grade == 'inspector1' then
		table.insert(elements, { label = _U('police_wear'), value = 'inspector1_wear' })
	elseif grade == 'inspector2' then
		table.insert(elements, { label = _U('police_wear'), value = 'inspector2_wear' })
	elseif grade == 'inspector3' then
		table.insert(elements, { label = _U('police_wear'), value = 'inspector3_wear' }) ]]--
	elseif grade == 'komisar1' then
		table.insert(elements, { label = _U('police_wear'), value = 'komisar1_wear' })
	--[[elseif grade == 'komisar2' then
		table.insert(elements, { label = _U('police_wear'), value = 'komisar2_wear' })
	elseif grade == 'komisar3' then
		table.insert(elements, { label = _U('police_wear'), value = 'komisar3_wear' }) ]]--
	...
	if Config.EnableNonFreemodePeds then
		table.insert(elements, { label = 'ГДБОП-1', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01' })
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		data.current.value == 'recruit_wear' or
			...
			data.current.value == 'inspector1_wear' or
			data.current.value == 'inspector2_wear' or
			data.current.value == 'inspector3_wear' or
			data.current.value == 'komisar1_wear' or
			data.current.value == 'komisar2_wear' or
			data.current.value == 'komisar3_wear' or
...
function OpenArmoryMenu(station)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory', {
		...
		if data.current.value == 'get_weapon' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'chef' or PlayerData.job.grade_name == 'komisar1') then
			OpenGetWeaponMenu()
		elseif data.current.value == 'put_weapon' then
			OpenPutWeaponMenu()
		elseif data.current.value == 'buy_weapons' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'chef' or PlayerData.job.grade_name == 'komisar1') then
			OpenBuyWeaponsMenu()
		elseif data.current.value == 'put_stock' then
			OpenPutStocksMenu()
		elseif data.current.value == 'get_stock' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'chef' or PlayerData.job.grade_name == 'komisar1') then
			OpenGetStocksMenu()
		end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				--{label = "Обществено полезен труд",	value = 'communityservice'},
				{ label = "Затвор", value = 'jail_menu' }
			}
			...
			if PlayerData.job.grade_name == 'boss' then
				table.insert(elements, { label = 'Дай лиценз за лов', value = 'hunting_license' })
			end
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'unpaid_bills' then
						...
						--[[elseif action == 'communityservice' then
							-- try using PlayerData instead of source
							local source = PlayerId()
							if source ~= nil then
								SendToCommunityService(GetPlayerServerId(closestPlayer), source)
							end ]]--
...
--[[function SendToCommunityService(player)
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'Community Service Menu', {
		...
		if community_services_count == nil then
			...
			TriggerServerEvent("whiskass:galiKote", player, community_services_count , source)
			menu.close()
		end
	...
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'police' then
			...
			for k, v in pairs(Config.PoliceStations) do
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'komisar1' then
