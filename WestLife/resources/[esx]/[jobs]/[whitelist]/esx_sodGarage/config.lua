...
Config.sodDatabaseName = 'sod'	-- set the exact name from your jobs database for sod

--sod Car Garage:
Config.CarZones = {
	sodCarGarage = {
		Pos = {
			{x = -1051.3811, y = -249.4758, z = 38.8607},
		}
	}
}
...
Config.HeliZones = {
	sodHeliGarage = {
		Pos = {
			{x = -447.3244, y = -312.5347, z = -10078.5566},
					}
	}
}
...
Config.BoatZones = {
	sodBoatGarage = {
		Pos = {
			{x = 1538.69,  y = 3901.5, z = -10030.35},
			{x = 2000.42,  y = 4500, z = -10033.437}
		}
	}
}

--sod Car Garage Blip Settings:
Config.CarGarageSprite = 357
Config.CarGarageDisplay = 4
Config.CarGarageScale = 0.65
Config.CarGarageColour = 38
Config.CarGarageName = "Гараж"
Config.EnableCarGarageBlip = false

-- sod Heli Garage Blip Settings:
Config.HeliGarageSprite = 43
Config.HeliGarageDisplay = 4
Config.HeliGarageScale = 0.65
Config.HeliGarageColour = 38
Config.HeliGarageName = "Гараж"
Config.EnableHeliGarageBlip = false

-- sod Boat Garage Blip Settings:
Config.BoatGarageSprite = 427
Config.BoatGarageDisplay = 4
Config.BoatGarageScale = 0.65
Config.BoatGarageColour = 38
Config.BoatGarageName = "Гараж"
Config.EnableBoatGarageBlip = false

-- sod Extra Menu Blip Settings:
Config.ExtraGarageSprite = 566
Config.ExtraGarageDisplay = 4
Config.ExtraGarageScale = 0.65
Config.ExtraGarageColour = 38
Config.ExtraGarageName = "Гараж"
Config.EnableExtraGarageBlip = false

-- sod Car Garage Marker Settings:
Config.sodCarMarker = 36 												-- marker type
Config.sodCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker
Config.sodCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "[E] За да отвориш гаража"			-- set your desired text here

-- sod Heli Garage Marker Settings:
Config.sodHeliMarker = 34 												-- marker type
Config.sodHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.sodHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "[E] За да отвориш гаража"		-- set your desired text here

-- sod Boat Garage Marker Settings:
Config.sodBoatMarker = 35 												-- marker type
Config.sodBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.sodBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "[E] За да отвориш гаража"		-- set your desired text here

-- sod Extra Garage Marker Settings:
Config.sodExtraMarker = 27 												-- marker type
Config.sodExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.sodExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~sod Extra Menu~s~"		-- set your desired text here

-- sod Cars:
Config.sodVehicles = {
		{ model = 'schafter3', label = 'Кола'},
		{ model = 'dubsta2', label = 'Джип'},				
}

-- sod Helicopters:
Config.sodHelicopters = {
	{ model = 'ec135', label = 'Болничен Хеликоптер', modLivery = 0, price = 0 }
}

-- sod Boats:
Config.sodBoats = {
	--{ model = 'predator', label = 'sod Predator', livery = 0, price = 0 }
}
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Прибиране на МПС"
Config.LabelGetVeh = "Взимане на МПС"
Config.LabelPrimaryCol = "Първичен"
Config.LabelSecondaryCol = "Второстепенен"
Config.LabelExtra = "Допълнително"
Config.LabelLivery = "Livery"
Config.TitlesodGarage = "Гараж"
Config.TitlesodExtra = "Допълнително"
Config.TitlesodLivery = "Livery"
Config.TitleColorType = "Цвят"
Config.TitleValues = "Стойност"

-- ESX.ShowNotifications:
Config.VehicleParked = "МПС Паркирано"
Config.NoVehicleNearby = "Няма МПС наблизо!"
Config.CarOutFromPolGar = "Взе МПС от гаража!"
Config.HeliOutFromPolGar = "Взе хеликоптер от ~y~гаража~s~!"
Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~sod Boat Garage~s~!"
Config.VehRepNotify = "Твоето МПС се поправя, изчакай!"
Config.VehRepDoneNotify = "Твоето МПС е ~y~поправено~s~!"
Config.VehCleanNotify = "Твоето МПС се ~y~почиства~s~, изчакай!"
Config.VehCleanDoneNotify = "Твоето МПС е ~y~почистено~s~!"
