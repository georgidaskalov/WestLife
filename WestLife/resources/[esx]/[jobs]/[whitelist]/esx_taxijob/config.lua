...
--Config.NPCJobEarnings             = {min = 450, max = 700}
Config.NPCJobEarnings             = {min = 220, max = 350}
...
Config.Locale                     = 'en'
 ...
 Config.AddItemsPercent = 50        --  This is percent the script will add items as well as cash from mugging.
...
Config.Zones = {
	...
	TaxiActions = {
		Pos   = {x = -1606.97, y = -843.71, z = 90000000.9},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 21, Rotate = true
	},
...
Config.JobLocations = {
	...
	{x = 123.70, y = 6606.26, z = 31.90},
	{x = 77.19, y = 6427.04, z = 31.52},
	{x = -438.72, y = 6023.15, z = 31.49},
	{x = -768.14, y = 5562.99, z = 33.61},
	{x = -202.32, y = 6565.12, z = 10.99},
	{x = 2210.58, y = 5601.38, z = 53.79},
	{x = 1727.69, y = 6407.04, z = 34.33},
	{x = 1831.76, y = 202.25, z = 172.44},
	{x = 1667.33, y = -25.38, z = 173.77},
	{x = 2561.90, y = 2709.96, z = 42.20},
}
