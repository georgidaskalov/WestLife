...
AddEventHandler('esx_taxijob:success', function()
	...
	if societyAccount then
		...
		if ir >= Config.AddItemsPercent then
		xPlayer.addInventoryItem('back1', 2)
		-- else
...
-- RegisterServerEvent('esx_taxijob:giveItems')
-- AddEventHandler('esx_taxijob:giveItems', function(source)
