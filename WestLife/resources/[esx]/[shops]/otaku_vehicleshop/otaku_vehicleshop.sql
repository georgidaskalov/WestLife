...
CREATE TABLE IF NOT EXISTS `vehicle_categories_npc` (
...
/*!40000 ALTER TABLE `vehicle_categories_npc` DISABLE KEYS */;
INSERT INTO `vehicle_categories_npc` (`id`, `name`, `label`) VALUES
	(1, 'compacts', 'Compacts'),
	(2, 'coupes', 'Coupés'),
	(3, 'ltdedition', 'Limited Edition'),
	(4, 'motorcycles', 'Motorbikes'),
	(5, 'muscle', 'Muscle'),
	(6, 'offroads', 'Off Road'),
	(7, 'sedans', 'Sedans'),
	(8, 'sports', 'Sports'),
	...
	(11, 'vans', 'Vans'),
	(12, 'supers', 'Super');
/*!40000 ALTER TABLE `vehicle_categories_npc` ENABLE KEYS */;


-- Dumping structure for table strp.vehicles
CREATE TABLE IF NOT EXISTS `vehicles_npc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40000 ALTER TABLE `vehicles_npc` DISABLE KEYS */;
INSERT INTO `vehicles_npc` (id, name, model, price, category, imglink) VALUES
...
/*!40000 ALTER TABLE `vehicles_npc` ENABLE KEYS */;
