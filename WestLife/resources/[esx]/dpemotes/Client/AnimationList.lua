...
DP.Emotes = {
   ...
   ["blowjob3"] = {"oddjobs@towing", "f_blow_job_loop", "Blowjob3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["blowjob4"] = {"rcmpaparazzo_2", "shag_loop_poppy", "Qanalreciver", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["blowjob5"] = {"rcmpaparazzo_2", "shag_loop_a", "Qanalgiver", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["wait3"] = {"switch@trevor@puking_into_fountain", "trev_fountain_puke_exit", "Wait 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["blowjob2"] = {"mini@prostitutes@sexnorm_veh", "bj_loop_prostitute", "Blowjob2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["blowjob"] = {"mini@prostitutes@sexlow_veh", "low_car_bj_loop_female", "Blowjob", AnimationOptions =
   {
       EmoteLoop = true,
   }},
