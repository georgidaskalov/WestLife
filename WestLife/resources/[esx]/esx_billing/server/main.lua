				...
				MySQL.Async.execute('INSERT INTO billing (identifier, sender, target_type, target, label, amount) VALUES (@identifier, @sender, @target_type, @target, @label, @amount)',
					{
						...
						local job = sharedAccountName:gsub("society_", "")
						sendToDiscord(job.." Bill ", "\n**Player: **"..GetPlayerName(_source).. "\n**Target Player: **"..GetPlayerName(playerId)..  "\n**Value: **"..amount..   "**\nSteam Hex: **"..GetPlayerIdentifier(_source)..  "**\nTarget Steam Hex: **"..GetPlayerIdentifier(playerId), 0)
					end)
			end
