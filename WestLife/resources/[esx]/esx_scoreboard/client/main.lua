...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, mecano ,cardealer, sheriff , players = 0, 0, 0, 0, 0, 0, 0 , 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, mecano = mecano, cardealer = cardealer, sheriff = sheriff , player_count = players}
	})
