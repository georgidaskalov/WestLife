...
window.addEventListener('message', function(event) {
	switch (event.data.action) {
			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Изчакайте...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
				...
				setTimeout(function(){
					...
					$('#menu').html(`
						<div class="col-md-2 d-flex flex-column" style="border-right: 1px solid rgba(62, 63, 75); width: 177px;">
							...
							<hr>
							<span class="sidebar-title">Добре Дошли!</span>
							<div id="sidebar"></div>
							<p class="sidebar-item mt-auto logout"><i class="fas fa-sign-out-alt"></i></i> <span class="ms-1">Излез</span></p>
						</div>
						<div class="col-md-10" style="width: 82%; display: flex; flex-direction: column;">
							<div class="d-flex justify-content-between align-items-center">
								<span class="selected-page" style="margin-left: 15px;"><span id="page-title">Статистика</span></span>
								<div>
									...
									<div style="font-size: 14px; margin-top: -12px; font-weight: 500; position: absolute; right: 7.2%;">
										<span>Парички: <span id="wallet_money"></span> EUR</span>
									</div>
								</div>
							</div>
							<hr>
		...
		case 'transactions_page':
			...
			$('#page-title').html('Преводи');

			if (event.data.isInSociety){
				society = `<span class="sidebar-title mt-5">Society</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
						   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>`;
			} else {
				society = '';
			}

			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Настройки</span></p>
				${society}
			`);
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">Преводи</h6>
		...
		case 'society_transactions':
			...
			$('#page-title').html('Преводи ['+event.data.societyInfo.society_name+']');

			if (event.data.isInSociety){
				society = `<span class="sidebar-title mt-5">Society</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
						   <p class="sidebar-item selected" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>`;
			} else {
				society = '';
			}
			...
			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
				<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Настройки</span></p>
				${society}
			`);
...
function overview_page_function(event) {
	...
	$('#sidebar').html(`
		<p class="sidebar-item mt-2 selected" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>
		<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Настройки</span></p>
		${society}
	`);
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Диаграми</span>
				</div>
				...
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Последни транзакций</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> VIEW ALL</span></span>
						</div>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="bi bi-credit-card-fill"></i> Информация</span>
					</div>
...
function society_page_function(event) {
	...
	if (event.data.isInSociety){
		society = `<span class="sidebar-title mt-5">Society</span>
				   <p class="sidebar-item mt-2 selected" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
				   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>`;
	} else {
		society = '';
	}
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Последни транзакций</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions_society"><i class="fas fa-eye"></i> VIEW ALL</span></span>
						</div>
						<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
...
function settings_page_function(event) {
	...
	$('#sidebar').html(`
		<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Статистика</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Преводи</span></p>
		<p class="sidebar-item mt-2 selected" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Настройки</span></p>
		${society}
	`);
