function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition)
	...
	self.setAccountMoney = function(acc, money, reason)
		...
		--exports['frozen-banking']:RegisterNewAction(self.source, accountName, 'reset', money, (reason ~= nil and reason or 'Unknown'))
	...
	self.addAccountMoney = function(acc, money, reason)
		...
		--exports['frozen-banking']:RegisterNewAction(self.source, accountName, 'deposit', money, (reason ~= nil and reason or 'Unknown'))
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end

	self.removeAccountMoney = function(acc, money, reason)
		if money < 0 then
		...
		--exports['frozen-banking']:RegisterNewAction(self.source, accountName, 'withdraw', money, (reason ~= nil and reason or 'Unknown'))
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end
