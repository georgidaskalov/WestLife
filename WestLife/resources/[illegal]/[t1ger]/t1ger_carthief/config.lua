...
-- PED:
	...
	Pos = {485.2101, -1528.8188, 28.3003},			-- set NPC coords here , , , 265
	Heading = 52.0,						-- set NPC heading
-- BLIP:
...
Config.CarThiefNPCName 		= "Крадец на коли"   	-- set name for NPC (the name that pops on on your phone example)
...
Config.RiskGrades = {
	[1] = { -- Risk Grade 1 --
		Grade = 1, Label = 'Low', Enabled = true, BuyPrice = 500, MinCops = 2, 
		Cars = {
	...
	[2] = { -- Risk Grade 2 --
		Grade = 2, Label = 'Medium', Enabled = true, BuyPrice = 2000, MinCops = 2, 
		Cars = {
	...
	[3] = { -- Risk Grade 3 --
		Grade = 3, Label = 'High', Enabled = true, BuyPrice = 5000, MinCops = 2, 
		Cars = {
			[1] = { Name = "Jester", Hash = -1297672541, Reward = 15000 },
			[2] = { Name = "Carbonizzare", Hash = 2072687711, Reward = 15000 },
			[3] = { Name = "Massacro", Hash = -142942670, Reward = 15000 },
			-- add more cars here
		}, 
	},
}
