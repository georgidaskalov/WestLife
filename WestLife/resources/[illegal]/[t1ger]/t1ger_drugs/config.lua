...
-- Drug Sale Settings:
Config.maxCap = 999999							-- max amount of drugs to be sold per server restart, to disable do not set to 0, instead set to 999999
Config.DrugSaleCooldown = 15					-- Cooldown between each selling in seconds.
Config.SellDrugsBarText = "ПРОДАЖБА НА НАРКОТИК"		-- Progress Bar Text for selling drugs
