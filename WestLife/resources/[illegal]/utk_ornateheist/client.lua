...
UTK = {
    ...
    alarmblip,
    text = { -- Texts
        loudstart = "[~r~E~w~] Старт обир на ~g~Банка~w~",
        silentstart = "",
        usecard = "[~r~E~w~] Използвай карта",
        usethermal = "[~r~E~w~] Използвай термален заряд",
        usehack = "[~r~E~w~] Хакване",
        uselockpick = "[~r~E~w~] Използвай шперц",
        usesearch = "[~r~E~w~] Претърси",
        lootcash= "[~r~E~w~] Вземи парите",
        lootgold = "[~r~E~w~] Вземи златото",
        lootdia = "[~r~E~w~] Вземи диамантите",
        card = "Използваш карта",
        thermal = "Поставяш термала бомба",
        burning = "Отваряш вратата",
        lockpick = "Отключваш вратата",
        using = "Хакваш панела",
        used = "Хакна панела.",
        stage = "Успешно.",
        search = "Търсене",
        hacking = "Хакване",
        melted = "Вратата е отключена.",
        hacked = "Хакването успешно.",
        unlocked = "Вратата е отключена.",
        nothing = "Нищо не намери.",
