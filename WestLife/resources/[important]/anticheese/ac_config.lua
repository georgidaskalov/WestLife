...
Components = {
	...
	["client.weaponblacklist"] = true, -- blacklist certain weapons in ac_c.lua
	["client.carblacklist"] = true, -- blacklist certain cars in ac_c.lua
	["client.carvisible"] = true, -- anti car invisibility
	["client.multidamage"] = true, -- anti multi damage, blocks damage multiplication
	["client.spectate"] = false, -- detects if cheater is spectating other players
	...
	["server.esx.kashacter"] = false, -- detect kashacters SQL Injection exploit
