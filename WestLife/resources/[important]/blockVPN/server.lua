...
--  CONFIG  --
--------------
local ownerEmail = 'bloodxsmith@gmail.com'             -- Owner Email (Required) - No account needed (Used Incase of Issues)
local kickThreshold = 0.99        -- Anything equal to or higher than this value will be kicked. (0.99 Recommended as Lowest)
local kickReason = 'Използвате VPN или Прокси , моля свържете се с екипа ни WestLifeRP https://discord.gg/W6A7Wm3c2U.'
