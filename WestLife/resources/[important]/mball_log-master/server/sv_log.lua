--Configuration--
local discordwebhook = 'Put your webhook here'
...
AddEventHandler('playerDropped', function(reason)
  ...
  local mb = Masipallopaa(_source)
    sendToDiscordLogsEmbed(3158326, '`❌` | Играч излиза',' Reason: `' ..reason.. '`\n Player: `' ..name.. '`\n Playtime: `' ..playtime.. '` Minutes \n Hex-ID: `' ..mb.identifier.. '`\n License: `' ..mb.license.. '`\n Discord ID: `' ..mb.discord.. '`\n XBL ID: `' ..mb.xbl.. '`\n Live ID: `' ..mb.live.. '`\n FiveM ID: `' ..mb.fivem.. '`\n IP: `' ..GetPlayerEndpoint(_source).. '`')
end)

AddEventHandler('chatMessage', function(source, name, msg)
  local mb = Masipallopaa(source)
  sendToDiscordLogsEmbed(3158326, '`💬` | Чат',' Player: `' ..name.. '`\n Message: `' ..msg.. '`\n Hex-ID: `' ..mb.identifier.. '`\n License: `' ..mb.license.. '`\n Discord ID: `' ..mb.discord.. '`\n XBL ID: `' ..mb.xbl.. '`\n Live ID: `' ..mb.live.. '`\n FiveM ID: `' ..mb.fivem.. '`\n IP: `' ..GetPlayerEndpoint(source)..'`')
end)
