    ...
    ESX.TriggerServerCallback('crew-phone:phone-check', function(durum)
      if durum ~= nil then
        ...
        if ShowNumberNotification == true then
          if message.transmitter == "police" or message.transmitter == "ambulance" or message.transmitter == "taxi" then
...
if hasFocus == true then
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
    exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/951961748607496192/mAokdcUknnVrg-wlopJxYoEFoce0uLMBhWRqXvL8I6uZ6vg2M_idJaVkjhkvRTignGab", data.field, function(data)
