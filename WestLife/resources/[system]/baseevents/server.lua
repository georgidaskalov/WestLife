...
local Weapons = {
    ...
    [`VEHICLE_WEAPON_ROTORS`] = {['weaponName'] = 'Rammed by car', ['type'] = 'Vehicle'},
}
...
AddEventHandler('baseevents:onPlayerKilled', function(killedBy, data)
    ...
    if victim then
        ...
        if name then
           ...
           -- exports['erp_adminmenu']:sendToDiscord('Player Death', msg, "16731983", "")
        end
    end
end)
...
AddEventHandler('baseevents:onPlayerDied', function(killedBy, pos, discordlog)
	...
	if discordlog then
		...
		--exports['erp_adminmenu']:sendToDiscord('Player Death', msg, "16732048", "")
	end
end)