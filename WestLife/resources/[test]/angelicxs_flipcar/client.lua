...
CreateThread(function()
	...
	RegisterCommand(Config.ChatCommand2, function()
            TriggerEvent('angelicxs-flipcar:ball')
        end)
end)

RegisterNetEvent('angelicxs-flipcar:ball')
AddEventHandler('angelicxs-flipcar:ball', function()
    ESX.Game.SpawnObject('stt_prop_stunt_soccer_lball', { x = 771.1283 , y = -233.6949, z = 66.1144  }, function(obj)
