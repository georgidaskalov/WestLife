...
print('Loaded ARPF by Xerxes468893©️ (Peter Greek©️) for BCDOJRP©️.') -- Do not Remove Pls!
print('Modifier par Baby©️ pour Black_Diamond_Rp©️ .Editer en Version ESX') -- Do not Remove Pls!
print('Edit by Baby© ️ for Black_Diamond_Rp©. Edit Version ESX') -- Do not Remove Pls!
local str = {}
